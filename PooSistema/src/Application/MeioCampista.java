...
public class MeioCampista extends Jogador {
    ...
    public MeioCampista(String nome, int idade, int velocidade, int finalizacao, int passe, int drible, int defesa, int fisico, int posicionamentoGol, int reflexoGol, int saltoGol){
		this.setNome(nome);
		this.idade = idade;
