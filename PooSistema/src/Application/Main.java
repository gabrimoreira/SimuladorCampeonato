...
public class Main {
    ...
    public static void main(String[] args) {
	    ...
	    Jogador LucasVazquez = new Jogador("Lucas Vázquez", "Defensor", 29, 81, 70, 78, 78, 71, 74, 1, 1, 1);
	    Jogador Courtois = new Jogador("Courtois", "Goleiro", 30, 60, 15, 35, 32, 19, 69, 84, 91, 86);
	    ...
	    Jogador TerStegen = new Jogador("Ter Stegen", "Goleiro", 31, 60, 15, 40, 33, 19, 65, 87, 87, 86);
	    Jogador InakiPena = new Jogador("Inaki Pena", "Goleiro", 22, 43, 11, 30, 28, 17, 60, 74, 75, 71);
	    
        //Jogadores Bayern:
        Jogador ChoupoMoting = new Jogador("Choupo Moting", "Atacante", 34, 74, 79, 75, 77, 39, 78, 1, 1, 1);
        ...
        Jogador Stanisic = new Jogador("Stanisic", "Defensor", 23, 73, 46, 75, 73, 77, 77, 1, 1, 1);
        ...
        Jogador Palmer = new Jogador("Palmer", "MeioCampista", 21, 76, 64, 70, 73, 47, 59, 1, 1, 1);
	    ...
	    Jogador Milner = new Jogador("Milner", "MeioCampista", 37, 55, 71, 78, 76, 77, 74, 1, 1, 1);
	    ...
	    Jogador Mukiele = new Jogador("Mukiele", "Defensor", 30, 83, 50, 75, 75, 78, 79, 1, 1, 1);
		...
		Jogador Gabigol = new Jogador("Gabigol", "Atacante", 26, 83, 79, 77, 84, 34, 76, 1, 1, 1);
	    Jogador Cano = new Jogador("Cano", "Atacante", 33, 73, 82, 72, 76, 27, 78, 1, 1, 1);
        ...
        Jogador Rony = new Jogador("Rony", "MeioCampista", 28, 80, 78, 76, 82, 55, 77, 1, 1, 1);
        ...
        Clube Brasileirao = new Clube("Melhores do Brasileirao", Gabigol, Suarez, Cano, Pedro, Rony, Arrascaeta, RaphaelVeiga, RenatoAugusto, Gerson, Andre, Fernandinho, Marcelo, AyrtonLucas, GustavoGomez, Nino, DavidLuiz, VitorCuesta, GuilhermeArana, Weverton, JoaoPaulo);
