...
public class Partida {
	...
	//Cada rodada do campeonato terá as 5 partidas a serem instanciadas de uma vez, passando clubes mandante e visitante.
...
//1. Põe o usuário numa tela pré-partida onde ele pode ver a escalação do adversário e overall, e escolher a escalação que ele irá usar dentre as escalações padrão(chamar a funcao do clube que define as escalacoes padrao, ja que podem have jogadores de fora. Podem haver tambem mudancas nos overais dos jogares conforme seu desempenho. Usuario escolhera entao com base nas escalacoes feitas com os jogadores disponiveis para aquela partida e nas habilidades atualizadas).

//2. Começa a simulação depois de escolhida a escalaçao

//3. Sorteia número de chutes e o número de chutes a gol (chutes certos) para cada time com base na qualidade geral de seu ataque, e na qualidade geral da defesa adversária. 
//Com base na qualidade dos atacantes e do goleiro adversário determina quantos chutes a gol vão entrar, definindo o placar. Define dentre o número de chutes quantos foram comuns ou de cabeça(defensores terão participação aumentada de caeça em relaçao a comuns), 
